    ...
    where TViewModel : ValidatingScreen<TViewModel>
{
	...
	static ValidatingScreen()
    {
        List<PropertyInfo> validatedProperties = (from propertyInfo in typeof(TViewModel).GetProperties()
            where propertyInfo.GetCustomAttributes<ValidationAttribute>(true).Any()
        ...
        propertyValidators = (from propertyInfo in validatedProperties
            let validators = propertyInfo.GetCustomAttributes<ValidationAttribute>(true).ToArray()
            select new
            {
                propertyInfo.Name,
        ...
        propertyValidationGroups = (from propertyInfo in validatedProperties
            let @group = propertyInfo.GetCustomAttributes<ValidationGroupAttribute>(true).FirstOrDefault()
            select new
            {
                propertyInfo.Name,
	...
	public string this[string propertyName]
    {
        get
        {
            ...
            {
                var value = propertyGetters[propertyName]((TViewModel)this);
