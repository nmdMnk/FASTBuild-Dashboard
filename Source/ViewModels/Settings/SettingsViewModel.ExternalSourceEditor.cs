...
internal partial class SettingsViewModel
{
    ...
    public ExternalSourceEditorMetadata SelectedExternalSourceEditor
    {
        ...
        set
        {
            ...
            this.NotifyOfPropertyChange(nameof(ExternalSourceEditorPath));
            this.NotifyOfPropertyChange(nameof(ExternalSourceEditorArgs));
            this.NotifyOfPropertyChange(nameof(ExternalSourceEditorAdditionalArgs));
        }
    }
    ...
    public void BrowseExternalSourceEditor()
    {
        var dialog = new VistaOpenFileDialog
        {
            ...
            FileName = ExternalSourceEditorPath
        };

        if (dialog.ShowDialog(App.Current.MainWindow) == true) ExternalSourceEditorPath = dialog.FileName;
    }
}